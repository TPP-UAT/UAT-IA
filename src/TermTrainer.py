...
class TermTrainer:
    ...
    def generate_model_for_group_of_terms(self, texts, keywords_by_text, term_id, training_input_creator):
        ...
        print("LEN keywords_by_text", len(keywords_by_text), keywords_by_text)
        ...
        flat_labels = label_encoder.fit_transform([str(label) for sublist in labels for label in sublist])
