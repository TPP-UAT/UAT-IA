    ...
    def generate_model_for_group_of_terms(self, texts, keywords_by_text, term_id, training_input_creator):
        ...
        if len(sequences_padded) < 2 or len(keywords_by_text) < 2:
            ...
            tuner = kt.Hyperband(my_hyper_model, objective="val_accuracy", max_epochs = 10, 
                     factor = 3, directory='models/tuner', project_name='tuner')
            ...
            # Retrain the model
            hypermodel.fit(train_data, train_labels, epochs=best_epoch, validation_split=0.2)

            eval_result = hypermodel.evaluate(train_data, train_labels)
            print("[test loss, test accuracy]:", eval_result)

            # model = self.create_model(number_of_categories=number_of_categories, 
