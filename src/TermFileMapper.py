...
class TermFileMapper:
    ...
    def add_term_file(self, term_id, file, term_children):
    ...
    def check_keywords_for_thesaurus_terms(self, keywords, thesaurus, file):
        for keyword in keywords:
            for _, term_value in thesaurus.get_terms().items():
                if keyword == term_value.get_name():
                    ...
                    self.add_term_file(term_id, file, term_children)
    ...
    def create_training_files(self, thesaurus):
        ...
        for file_name in files:
            ...
            self.check_keywords_for_thesaurus_terms(keywords, thesaurus, file)
