...
# Configure logging
logging.basicConfig(filename='logs/no_keyword_files_deleted.log', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')

# Define the folder path and regex pattern
root_folder_path = os.getenv('DATA_PATH')
